#!/usr/bin/env node
// QVAC Complaint Letter Writer — GUI mode.
...
import { generate } from "./complaint.js";

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const PORT = process.env.PORT ? Number(process.env.PORT) : 29347;
...
async function main() {
  ...
  server.listen(PORT, () => {
    console.log(`▸ QVAC Complaint Letter Writer GUI ready at http://localhost:${PORT}`);
  });
